...
#ifndef _DSI_IRIS3_LIGHTUP_OCP_H_
#define _DSI_IRIS3_LIGHTUP_OCP_H_
...
int iris3_dsi_cmds_send(struct dsi_panel *panel, struct dsi_cmd_desc *cmds, u32 count, enum dsi_cmd_set_state state);
int iris_i2c_read_panel_data( u32 reg_addr, u32 size, u32 *pvalues);

#endif // _DSI_IRIS3_LIGHTUP_OCP_H_
